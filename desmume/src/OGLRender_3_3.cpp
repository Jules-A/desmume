...
OGLEXT(PFNGLBINDFRAGDATALOCATIONINDEXEDPROC, glBindFragDataLocationIndexed) // Core in v3.2
...
void OGLLoadEntryPoints_3_3()
{
	...
	INITOGLEXT(PFNGLBINDFRAGDATALOCATIONINDEXEDPROC, glBindFragDataLocationIndexed) // Core in v3.2
...
Render3DError OpenGLRenderer_3_3::CreateGeometryPrograms()
{
	Render3DError error = OGLERROR_NOERR;
	OGLRenderRef &OGLRef = *this->ref;
...
void OpenGLRenderer_3_3::DestroyGeometryPrograms()
{
...
Render3DError OpenGLRenderer_3_3::CreateGeometryZeroDstAlphaProgram(const char *vtxShaderCString, const char *fragShaderCString)
{
	Render3DError error = OGLERROR_NOERR;
	OGLRenderRef &OGLRef = *this->ref;
...
Render3DError OpenGLRenderer_3_3::CreateMSGeometryZeroDstAlphaProgram(const char *vtxShaderCString, const char *fragShaderCString)
{
	Render3DError error = OGLERROR_NOERR;
	OGLRenderRef &OGLRef = *this->ref;
...
void OpenGLRenderer_3_3::DestroyMSGeometryZeroDstAlphaProgram()
{
	OGLRenderRef &OGLRef = *this->ref;
...
Render3DError OpenGLRenderer_3_3::CreateEdgeMarkProgram(const char *vtxShaderCString, const char *fragShaderCString)
{
	Render3DError error = OGLERROR_NOERR;
	OGLRenderRef &OGLRef = *this->ref;
...
Render3DError OpenGLRenderer_3_3::CreateFogProgram(const OGLFogProgramKey fogProgramKey, const char *vtxShaderCString, const char *fragShaderCString)
{
	Render3DError error = OGLERROR_NOERR;
	OGLRenderRef &OGLRef = *this->ref;
...
Render3DError OpenGLRenderer_3_3::CreateFramebufferOutput6665Program(const size_t outColorIndex, const char *vtxShaderCString, const char *fragShaderCString)
{
	Render3DError error = OGLERROR_NOERR;
	OGLRenderRef &OGLRef = *this->ref;
...
Render3DError OpenGLRenderer_3_3::CreateFramebufferOutput8888Program(const size_t outColorIndex, const char *vtxShaderCString, const char *fragShaderCString)
{
	OGLRenderRef &OGLRef = *this->ref;
...
void OpenGLRenderer_3_3::_SetupGeometryShaders(const OGLGeometryFlags flags)
{
...
Render3DError OpenGLRenderer_3_3::ZeroDstAlphaPass(const CPoly *clippedPolyList, const size_t clippedPolyCount, bool enableAlphaBlending, size_t indexOffset, POLYGON_ATTR lastPolyAttr)
{
	OGLRenderRef &OGLRef = *this->ref;
...
void OpenGLRenderer_3_3::_ResolveWorkingBackFacing()
{
	OGLRenderRef &OGLRef = *this->ref;
...
Render3DError OpenGLRenderer_3_3::PostprocessFramebuffer()
{
	OGLRenderRef &OGLRef = *this->ref;
...
Render3DError OpenGLRenderer_3_3::ClearUsingImage(const u16 *__restrict colorBuffer, const u32 *__restrict depthBuffer, const u8 *__restrict fogBuffer, const u8 opaquePolyID)
{
	OGLRenderRef &OGLRef = *this->ref;
